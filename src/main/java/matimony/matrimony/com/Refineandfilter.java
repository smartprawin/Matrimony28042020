...
public class Refineandfilter extends BaseTest {
	Actions acc;
...
//			Thread.sleep(5000);
			...
			Thread.sleep(10000);
			 ...
			 try {
	        	 WebElement abc = driver.findElement(By.xpath("//div[text()='Profile type']"));
	             JavascriptExecutor jse = (JavascriptExecutor)driver;
	             jse.executeScript("arguments[0].scrollintoView(true)", abc);
			} catch (Exception e) {
				// TODO: handle exception
			}
//			Thread.sleep(5000);
...
//			Thread.sleep(5000);
			...
			Thread.sleep(15000);
//			try {
//				 WebElement element = driver.findElement(By.xpath("//div[text()='Age From']"));
...
//                    
                 ...
                 ////marital status///
					...
					driver.findElement(By.id("facetMaritalStatuslabel")).click();
						...
						} else if (driver.findElement(By.id("maritalStatus1")).isSelected()) {
						...
						if (!driver.findElement(By.id("maritalStatus2")).isSelected()) {
                            System.out.println("not selected");
						} else if (driver.findElement(By.id("maritalStatus2")).isSelected()) {
							 BaseTest.click(driver.findElement(By.id("maritalStatus2")));

						}
						Thread.sleep(5000);

						if (!driver.findElement(By.id("maritalStatus3")).isSelected()) {
                            System.out.println("not selected");
						} else if (driver.findElement(By.id("maritalStatus3")).isSelected()) {
							 BaseTest.click(driver.findElement(By.id("maritalStatus3")));

						}
						Thread.sleep(5000);

						if (!driver.findElement(By.id("maritalStatus4")).isSelected()) {
                            System.out.println("not selected");
						} else if (driver.findElement(By.id("maritalStatus4")).isSelected()) {
						...
						if (unmarr.contains("Widow / Widower")) {
							 BaseTest.click(driver.findElement(By.id("maritalStatus2")));
						...
						String mar = BaseTest.getExcelData("Sheet1", 1, 4);
						Thread.sleep(5000);
			...
			driver.findElement(By.xpath("//*[@id='FMoreMotherTongue']/a")).click();
			...
			Thread.sleep(5000);
	         try {
	        	 WebElement cit = driver.findElement(By.xpath("//option[text()='"+getExcelDatarefine("Sheet1", 1, 16)+"']"));
	         ...
	         //--
				...
				driver.findElement(By.xpath("//*[@id='facetMotherTongue']/dl/dd/a")).click();
				//
				Thread.sleep(5000);
			...
			String mothertou = BaseTest.getExcelData("Sheet1", 1, 16);
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
            driver.findElement(By.xpath("//*[@id='FMoreEducation']/a")).click();
			//--
            
            driver.findElement(By.id("subeducationTemp")).click();
			Thread.sleep(5000);
	         try {
	        	 WebElement cit = driver.findElement(By.xpath("//option[text()='"+getExcelDatarefine("Sheet1", 1, 16)+"']"));
			...
			String educat = "B.A";
			String any = "Any";
			String educatd = BaseTest.getExcelData("Sheet1", 1, 17);
			
			if (educa.equals(educat)||educa.equals(educatd)||educa.equals("Any")) {
			...
			try {
	        	 WebElement button = driver.findElement(By.xpath("//div[text()='Family Type']"));
	             JavascriptExecutor jse = (JavascriptExecutor)driver;
	             jse.executeScript("arguments[0].scrollintoView(true)", button);
			} catch (Exception e) {
				// TODO: handle exception
			...
			driver.findElement(By.xpath("//*[@id=\"FMoreFamilyType\"]/a")).click();
			Thread.sleep(5000);


			
			if (!driver.findElement(By.id("FamilyType1")).isSelected()) {
                System.out.println("not selected");
			} else if (driver.findElement(By.id("FamilyType1")).isSelected()) {
				 BaseTest.click(driver.findElement(By.id("FamilyType1")));

			}
			Thread.sleep(5000);

			
			if (!driver.findElement(By.id("FamilyType2")).isSelected()) {
               System.out.println("not selected");
			} else if (driver.findElement(By.id("FamilyType2")).isSelected()) {
				 BaseTest.click(driver.findElement(By.id("FamilyType2")));

			}

			Thread.sleep(5000);
			
			String familytype = BaseTest.getExcelDatasearch("Sheet1", 1, 18);
			if (familytype.contains("Joint family")) {
				 BaseTest.click(driver.findElement(By.id("FamilyType1")));
			...
			String familytype5 = BaseTest.getExcelDatasearch("Sheet1", 1, 18);

			if (familytype5.contains("Nuclear family")) {
				 BaseTest.click(driver.findElement(By.id("FamilyType2")));
			...
			driver.findElement(By.xpath("//*[@id='facetFamilyTypelabel']")).click();
			Thread.sleep(5000);
		
			
			driver.findElement(By.xpath("//*[@id='facetFamilyType']/dl/dd/a")).click();
			...
			String family = BaseTest.getExcelData("Sheet1", 1, 14);
          ...
          driver.findElement(By.xpath("//*[@id='FMoreEmployedIn']/a")).click();
			
			//String familhy = driver.findElement(By.xpath("//*[@id='MoreFamilyType']/div[1]/div[4]/span[3]/label")).getText();
            
          if (!driver.findElement(By.id("occupationCat1")).isSelected()) {
              System.out.println("not selected");
			} else if (driver.findElement(By.id("occupationCat1")).isSelected()) {
				 BaseTest.click(driver.findElement(By.id("occupationCat1")));
			...
			if (!driver.findElement(By.id("occupationCat2")).isSelected()) {
             System.out.println("not selected");
			} else if (driver.findElement(By.id("occupationCat2")).isSelected()) {
			...
			if (!driver.findElement(By.id("occupationCat3")).isSelected()) {
             System.out.println("not selected");
			} else if (driver.findElement(By.id("occupationCat3")).isSelected()) {
			...
			if (!driver.findElement(By.id("occupationCat6")).isSelected()) {
             System.out.println("not selected");
			} else if (driver.findElement(By.id("occupationCat6")).isSelected()) {
				 BaseTest.click(driver.findElement(By.id("occupationCat6")));

			}
			if (!driver.findElement(By.id("occupationCat7")).isSelected()) {
	             System.out.println("not selected");
				} else if (driver.findElement(By.id("occupationCat7")).isSelected()) {
			...
			String empl = BaseTest.getExcelDatasearch("Sheet1", 1, 19);
			if (empl.contains("Government")) {
				 BaseTest.click(driver.findElement(By.id("occupationCat1")));

				
			}
			Thread.sleep(5000);
			String empdef = BaseTest.getExcelDatasearch("Sheet1", 1, 19);

			
			if (empdef.contains("Defence")) {
				 BaseTest.click(driver.findElement(By.id("occupationCat2")));

				
			}
			Thread.sleep(5000);
			String empdefp = BaseTest.getExcelDatasearch("Sheet1", 1, 19);

			if (empdefp.contains("Private")) {
				 BaseTest.click(driver.findElement(By.id("occupationCat3")));

				
			}
			Thread.sleep(5000);
			String empdefpsl = BaseTest.getExcelDatasearch("Sheet1", 1, 19);

			if (empdefpsl.contains("Self Employed")) {
				 BaseTest.click(driver.findElement(By.id("occupationCat6")));
			...
			Thread.sleep(5000);
			String empdefpslnot = BaseTest.getExcelDatasearch("Sheet1", 1, 19);

			if (empdefpslnot.contains("Not Working")) {
				 BaseTest.click(driver.findElement(By.id("occupationCat7")));
         ...
         driver.findElement(By.id("facetEmployedInlabel")).click();
			...
			String employmentin = BaseTest.getExcelData("Sheet1", 1, 19);
