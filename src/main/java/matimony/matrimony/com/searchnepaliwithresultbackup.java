...
public class searchnepaliwithresultbackup extends BaseTest {
	Actions acc;
...
//////// mother tounge////////////
		...
		try {
		acc.doubleClick(driver.findElement(By.xpath("//option[(text()='"+getExcelDatasearch("Sheet1", 1,  6)+"')]"))).perform();
//			acc.doubleClick(driver.findElement(By.xpath("//option[(text()='"+getExcelDatasearch("Sheet1", 1,  6)+"')]"))).perform();
		...
		//acc.doubleClick(
		//acc.(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 1, 11 )+"')].")DoubleClick)));
		...
		String shwoprofilewith = BaseTest.getExcelDatasearch("Sheet1", 1, 11);
		...
		String marital_statusmodi = BaseTest.getExcelDatasearch("Sheet1", 2, 0);
		if (marital_statusmodi.contains("Unmarried")&&!g.getunmarried().isSelected()) {
			 BaseTest.click(g.getunmarried());
			 System.out.println("unmarried selected");
			 Thread.sleep(5000);
		...
		if (marital_statuswid5.contains("Widow / Widower")&&!g.getwidow().isSelected()) {
				 ...
				 marital_statusdiv5 = BaseTest.getExcelDatasearch("Sheet1", 2, 24);

			} if (marital_statusdiv5.contains("Divorced")&&!g.getdivorced().isSelected()) {
				 BaseTest.click(g.getdivorced());
				 System.out.println("divorced selected");
...
////////mother tounge////////////
 ...
 shwoprofilewith5 = BaseTest.getExcelDatasearch("Sheet1", 2, 11);
	if (shwoprofilewith5.contains("photo")&&!g.getphotoOpt().isSelected()) {
		 BaseTest.click(g.getphotoOpt());
		 System.out.println("photo selected");
		 
			
		}else if (shwoprofilewith5.contains("Horoscope")&&!g.gethoroscopeOpt().isSelected()) {
			 BaseTest.click(g.gethoroscopeOpt());
			 System.out.println("horoscope selected");
	...
	////dont show///
	String dnotshow5 = BaseTest.getExcelDatasearch("Sheet1", 2, 12);
	if (dnotshow5.contains("Profiles already contacted")&&!g.getalreadyContOpt().isSelected()) {
		 BaseTest.click(g.getalreadyContOpt());
		 System.out.println("profile already contacted selected");
		 
			
		}else if (dnotshow5.contains("Profiles already viewed")&&!g.getalreadyViewedOpt().isSelected()) {
			 BaseTest.click(g.getalreadyViewedOpt());
			 System.out.println("Profiles already viewed selected");
			 
		}else if (dnotshow5.contains("Shortlisted profiles ")&&!g.getshortlistOpt().isSelected()) {
			 BaseTest.click(g.getshortlistOpt());
			 System.out.println("Shortlisted profiles  selected");
			 
		}else if (dnotshow5.contains("Profiles i have blocked")&&!g.getignoredOpt().isSelected()) {
			 BaseTest.click(g.getignoredOpt());
			 System.out.println("Profiles i have blocked selected");
		}else if (dnotshow5.contains("Profiles i have ignored")&&!g.getigOpt().isSelected()) {
			 BaseTest.click(g.getigOpt());
			 System.out.println("Profiles i have ignored selected");
		}else {
	...
	driver.findElement(By.xpath("//input[@value='Search']")).click();
			...
			String match = driver.findElement(By.xpath("//span[@class=\"input-data\"]")).getText();
...
//			acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 1, 13)+"')]")));
			...
			String RS = BaseTest.getExcelDatasearch("Sheet1", 1, 15);
		...
		/// food style///
			...
			String shwoprofileadv = BaseTest.getExcelDatasearch("Sheet1", 1, 11);
			...
			String dnotshows = BaseTest.getExcelDatasearch("Sheet1", 1, 12);
			...
			if (driver.findElement(By.xpath("//input[@value='Modify Search']")).isDisplayed()) {
				...
				Thread.sleep(5000);
				BaseTest.select_text(driver.findElement(By.id("heightTo")), BaseTest.getExcelDatasearch("Sheet1", 3, 3));
				Thread.sleep(5000);
				
				
				String marital_status6 = BaseTest.getExcelDatasearch("Sheet1", 3, 0);
				if (marital_status6.contains("Unmarried")&&!g.getunmarried().isSelected()) {
					 BaseTest.click(g.getunmarried());
					 System.out.println("unmarried selected");
					 Thread.sleep(5000);
				...
				marital_statuswid6 = BaseTest.getExcelDatasearch("Sheet1", 3, 23);

				if (marital_statuswid6.contains("Widow / Widower")&&!g.getwidow().isSelected()) {
						 BaseTest.click(g.getwidow());
						 System.out.println("widow selected");
						 
						 marital_statusdiv6 = BaseTest.getExcelDatasearch("Sheet1", 3, 24);

					} if (marital_statusdiv6.contains("Divorced")&&!g.getdivorced().isSelected()) {
						 BaseTest.click(g.getdivorced());
						 System.out.println("divorced selected");
					...
					try {
						 marital_statussep6 = BaseTest.getExcelDatasearch("Sheet1", 1, 25);

							if (marital_statussep6.contains("Separated")&&!g.getseprated().isSelected()) {
								 BaseTest.click(g.getseprated());
								 System.out.println("seprated selected");
							}else {
				...
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 22)+"')]")));
				} catch (Exception e) {
					// TODO: handle exception
				}
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 6)+"')]")));

				
				///phy status///
				
				String physicalstatus6 = BaseTest.getExcelDatasearch("Sheet1", 3, 5);
				if (physicalstatus6.contains("Doesn't matter")&&!g.getphysicaldsntm().isSelected()) {
					 BaseTest.click(g.getphysicaldsntm());
					 System.out.println("physical status doesntmatter selected");
					 
						
					}else if (physicalstatus6.contains("Normal")&&!g.getphyscialnorma().isSelected()) {
						 BaseTest.click(g.getphyscialnorma());
						 System.out.println("Physical status normal selected");
						 
					}else if (physicalstatus6.contains("Physically Challenged")&&!g.getphysicalphychangleed().isSelected()) {
						 BaseTest.click(g.getphysicalphychangleed());
						 System.out.println("Physically Challenged  selected");
				...
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 14)+"')]")));
...
//				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 1, 13)+"')]")));
				...
				///
				WebElement elementfg = driver.findElement(By.id("countryTemp"));
				Select Selectorfg = new Select(elementfg);
			    Selectorfg.getFirstSelectedOption();
			    
			    
			    
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 13)+"')]")));
	             
				//////resident status////
				
				String RSs = BaseTest.getExcelDatasearch("Sheet1", 3, 15);
				if (RSs.contains("Any")&&!g.getrsany().isSelected()) {
					 BaseTest.click(g.getrsany());
					 System.out.println("Resident status any selected");
				...
				WebElement educationss1 = driver.findElement(By.id("educationTemp"));
				Select educations1 = new Select(educationss1);
				education.getFirstSelectedOption();
			    
			    
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 8)+"')]")));
	           
				WebElement occupationss1 = driver.findElement(By.id("occupationTemp"));
				Select occupationsss = new Select(occupationss1);
				occupationsss.getFirstSelectedOption();
			    
			    
				acc.doubleClick(driver.findElement(By.xpath("//option[contains(text(),'"+getExcelDatasearch("Sheet1", 3, 9)+"')]")));
			...
			/// food style///
				...
				String foodhabit6 = BaseTest.getExcelDatasearch("Sheet1", 3, 17);
				if (foodhabit6.contains("Vegetarian")&&!g.geteatingHabits1().isSelected()) {
					 BaseTest.click(g.geteatingHabits1());
					 System.out.println("veg selected");
					 
						
					}else if (foodhabit6.contains("Non vegetarian")&&!g.geteatingHabits2().isSelected()) {
						 BaseTest.click(g.geteatingHabits2());
						 System.out.println("Non veg selected");
						 
					}else if (foodhabit6.contains("Any")&&!g.geteatingHabits0().isSelected()) {
						 BaseTest.click(g.geteatingHabits0());
						 System.out.println("foodhabit doesnt matter selected");
						 
					}else if (foodhabit6.contains("Eggetarian")&&!g.geteatingHabits3().isSelected()) {
						 BaseTest.click(g.geteatingHabits3());
						 System.out.println("egg selected");
						 
					}else if (foodhabit6.contains("Vegan")&&!g.geteatingHabits4().isSelected()) {
						 BaseTest.click(g.geteatingHabits4());
						 System.out.println("vegan selected");
				...
				String drinkinghabit6 = BaseTest.getExcelDatasearch("Sheet1", 3, 18);
				if (drinkinghabit6.contains("Non-drinker")&&!g.getdrinking1().isSelected()) {
					 BaseTest.click(g.getdrinking1());
					 System.out.println("non drinker selected");
					 
						
					}else if (drinkinghabit6.contains("Light / Social drinker")&&!g.getdrinking2().isSelected()) {
						 BaseTest.click(g.getdrinking2());
						 System.out.println("light/social drinker selected");
						 
					}else if (drinkinghabit6.contains("Any")&&!g.getdrinking0().isSelected()) {
						 BaseTest.click(g.getdrinking0());
						 System.out.println("drinker any selected");
						 
					}else if (drinkinghabit6.contains("Regular drinker")&&!g.getdrinking3().isSelected()) {
						 BaseTest.click(g.getdrinking3());
						 System.out.println("Regular drinker selected");
				...
				String smokehabit6 = BaseTest.getExcelDatasearch("Sheet1", 3, 19);
				if (smokehabit6.contains("Non-smoker")&&!g.getsmoking1().isSelected()) {
					 BaseTest.click(g.getsmoking1());
					 System.out.println("non smoker selected");
					 
						
					}else if (smokehabit6.contains("Light / Social smoker")&&!g.getsmoking2().isSelected()) {
						 BaseTest.click(g.getsmoking2());
						 System.out.println("light/social smoker selected");
						 
					}else if (smokehabit6.contains("Any")&&!g.getsmoking0().isSelected()) {
						 BaseTest.click(g.getsmoking0());
						 System.out.println("smoker doesnt matter selected");
						 
					}else if (smokehabit6.contains("Regular smoker")&&!g.getsmoking3().isSelected()) {
						 BaseTest.click(g.getsmoking3());
						 System.out.println("Regular smoker selected");
				...
				String shwoprofileadv6 = BaseTest.getExcelDatasearch("Sheet1", 3, 11);
				if (shwoprofileadv6.contains("photo")&&!g.getphotoOpt().isSelected()) {
					 BaseTest.click(g.getphotoOpt());
					 System.out.println("photo selected");
					 
						
					}else if (shwoprofileadv6.contains("Horoscope")&&!g.gethoroscopeOpt().isSelected()) {
						 BaseTest.click(g.gethoroscopeOpt());
						 System.out.println("horoscope selected");
				...
				String dnotshows6 = BaseTest.getExcelDatasearch("Sheet1", 3, 12);
				if (dnotshows6.contains("Profiles already contacted")&&!g.getalreadyContOpt().isSelected()) {
					 BaseTest.click(g.getalreadyContOpt());
					 System.out.println("profile already contacted selected");
					 
						
					}else if (dnotshows6.contains("Profiles already viewed")&&!g.getalreadyViewedOpt().isSelected()) {
						 BaseTest.click(g.getalreadyViewedOpt());
						 System.out.println("Profiles already viewed selected");
						 
					}else if (dnotshows6.contains("Shortlisted profiles ")&&!g.getshortlistOpt().isSelected()) {
						 BaseTest.click(g.getshortlistOpt());
						 System.out.println("Shortlisted profiles  selected");
						 
					}else if (dnotshows6.contains("Profiles i have blocked")&&!g.getignoredOpt().isSelected()) {
						 BaseTest.click(g.getignoredOpt());
						 System.out.println("Profiles i have blocked selected");
					}else if (dnotshows6.contains("Profiles i have ignored")&&!g.getigOpt().isSelected()) {
						 BaseTest.click(g.getigOpt());
						 System.out.println("Profiles i have ignored selected");
					}else {
