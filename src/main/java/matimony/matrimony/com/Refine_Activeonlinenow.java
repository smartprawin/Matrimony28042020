...
public class Refine_Activeonlinenow extends BaseTest {
	Actions acc;
	...
	public void setup6() throws Throwable {
		...
		try {
			...
			driver.findElement(By.xpath("(//a[@class='clr5 txtnone srch-line'])[4]")).click();
...
//								}           
						...
						try {
				             ...
				             WebElement element = driver.findElement(By.xpath("(//span[text()='Profile Created for '])["+i+"]"));
					...
					Thread.sleep(10000);
					WebElement matid = driver.findElement(By.xpath("(//span[text()='Online '])["+i+"]"));
					Thread.sleep(10000);

					String matriid = matid.getText();
					Thread.sleep(10000);

					System.out.println( i+"st online id = "+ matriid);
